...
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS content_contract_version INTEGER DEFAULT 2 NOT NULL;
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS revision BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS media_source_account_id VARCHAR(36) CONSTRAINT fk_task_media_source_account REFERENCES accounts(account_id) ON DELETE SET NULL;
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS media_source_message_id BIGINT;
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS media_source_meta JSONB;
ALTER TABLE IF EXISTS scheduled_message_tasks
    ADD COLUMN IF NOT EXISTS media_source_state VARCHAR(24) DEFAULT 'none' NOT NULL;
ALTER TABLE IF EXISTS scheduled_message_tasks
