...
from backend.database.models import Account, MediaType, Resource, ScheduledMessageTask
...
async def show_task_list(event, user_id: int):
    """显示任务列表。"""
    from backend.bot.handlers.selector_context import clear_selector_context
