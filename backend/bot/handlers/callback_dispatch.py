...
from backend.bot.handlers.auth_gate import require_db_user_id
from backend.bot.handlers.account_management import (
    show_accounts_list,
    sync_account_resources,
)
from backend.bot.handlers.task_target_selection import (
...
from backend.bot.handlers.task_management import (
    confirm_delete_task,
    create_new_task,
    delete_task,
    open_h5_webapp,
