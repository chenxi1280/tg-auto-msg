...
AUDIT_ACTION_LABELS = {
    ...
    "admin.create_clash_address": "新增 Clash 地址",
    "admin.update_clash_address": "更新 Clash 地址",
    "admin.delete_clash_address": "删除 Clash 地址",
    "admin.activate_clash_address": "启用 Clash 地址",
